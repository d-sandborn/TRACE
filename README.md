...
This software is the Python port of [TRACEv1](https://github.com/BRCScienceProducts/TRACEv1) and is developed in parallel with [ESPER](https://github.com/BRCScienceProducts/ESPER) and [PyESPER](https://github.com/LarissaMDias/PyESPER). This work is the subject of a peer-reviewed publication: [Sandborn et al. (2026)](https://doi.org/10.5194/gmd-19-5961-2026). 
